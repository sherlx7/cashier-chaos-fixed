...
1. **Making your changes:**
   ...
   - Use tailwindcss
   - Use typescript.
   - Folder names and file names should be in snake case, example `src/components/home-page/some-file.tsx`.
...
- **name**: A unique name for your package it should start with `@abcxvz/`. example `@abcxvz/my-game-123`.
